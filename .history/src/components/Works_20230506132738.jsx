      ...
      >
        ...
        <div className='mt-5'>
          <h3 className='text-white text-xl font-bold'>
            <a className='hover:text-purple-300 hover:scale-125 transform transistion duration-500 ease-in-out' href={project_link} target='_blank' rel='noopener noreferrer'>
              {name}
            </a>
          </h3>
