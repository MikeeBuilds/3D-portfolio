        ...
        <div className='flex flex-col items-center justify-center mt-5'>
          ...
          <div className=''> 
            <h1 className={`${styles.heroHeadText} text-white`}> 
              Hi, I'm <span className='text-[#915eff]'>Algo</span>
            </h1>
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              I'm a Web3 Developer based in Ft Lauderdale, FL. I specialize in building and
                ...
                I'm currently building with Solidity and Web3.js using React, Next.js, Tailwindcss and Three.js to bring your  
