          ...
          <div className="mt-8">
            <div className="p-4 bg-black-100 rounded-lg">
              ...
              <p className="text-white">
                Greetings! I'm Mike—a passionate React developer dedicated to
          ...
          <div className="mt-8">
            <div className="p-4 bg-black-100 rounded-lg">
              ...
              <p className="text-white">
                ...
                tailored smart contracts that cater specifically to your
                project's requirements. From comprehensive tokenomics and
                contract migration to ensuring proper provenance and
                implementing whitelisting, we handle it all. Explore our
                projects page for inspiring examples of our work.
              </p>
            </div>
          </div>
