...
On this website, you will find a showcase of my projects that demonstrate my skills and expertise. <br/> Each project has been carefully crafted to showcase my abilities in web development, from the design and user experience to the underlying code. I specialize in developing web3 and DeFi applications, which requires a deep understanding of blockchain technologies and their implementation.
