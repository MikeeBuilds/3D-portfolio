    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          max-w-3xl mt-3 "
        >
          I am a dedicated full-stack developer based in Oklahoma <br />
          <br />
          With expertise in React, TailwindCSS, Next.js, Three.js, and AI/LLMs,
          ...
          <br />
          <br />
          My diverse portfolio ranges from e-commerce platforms to online learning systems, showcasing my ability to deliver innovative solutions across various technologies and industries. <br />
          <br />
