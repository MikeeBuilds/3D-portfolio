  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.heroSubText}>Who am </p>
          ...
          <div className="mt-8">
            <div className="p-4 bg-black-100 rounded-lg">
              ...
              <p className="text-white">
                I'm a passionate React developer dedicated to crafting dynamic
                ...
                applications driven by blockchain technologies. Originating from
                a background as an Outdoor Photographer and bow hunting guide,
          ...
          <div className="mt-8">
            <div className="p-4 bg-black-100 rounded-lg">
              ...
              <p className="text-white">
                ...
                climate tech and outdoor innovation. I'm on the lookout for
