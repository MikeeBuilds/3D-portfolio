          ...
          <div className="mt-8">
            <div className="p-4 bg-black-100 rounded-lg">
              ...
              <p className="text-white">
                ...
                climate tech and outdoor innovation. Building solutions for our worlds problems <br /> <br />I'm on the lookout for
                challenges where I can apply tech solutions, seamlessly blending
                my love for the outdoors with the power of code. <br /> <br />A remote
