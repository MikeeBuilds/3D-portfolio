    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        className='w-full text-secondary text-[17px] font-semibold leading-[30px]
          max-w-3xl mt-3 '
        >
          Welcome to my portfolio website! My name is Algo and I am a dedicated self-taught full-stack developer based in Ft Lauderdale Florida. <br></br> I specialize in building web applications using React, TailwindCSS, Next.js, and Three.js. I have a passion for solving complex problems and experience working with various technologies. As a web3 and DeFi builder, I am constantly exploring and experimenting with the latest blockchain and decentralized technologies to build the future of the web.

On this website, you will find a showcase of my projects that demonstrate my skills and expertise. Each project has been carefully crafted to showcase my abilities in web development, from the design and user experience to the underlying code. I specialize in developing web3 and DeFi applications, which requires a deep understanding of blockchain technologies and their implementation.
...
Whether you are interested in exploring my portfolio, learning more about my experience, or discussing potential collaboration opportunities, I invite you to explore my website and get in touch.
          <a 
            ...
            className='text-[#915eff] font-semibold'> Github </a>
