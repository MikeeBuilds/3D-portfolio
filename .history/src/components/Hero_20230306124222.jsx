      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        <div className='flex flex-col items-center justify-center mt-5'>
          ...
          <div className=''> 
            ...
            A Web3 Developer based in FL specializing in building and designing decentralized web applications with React, Next.js, Tailwindcss, and Three.js. Building with Solidity and Web3.js to bring ideas to life.
