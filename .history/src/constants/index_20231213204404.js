import {
  ...
  const projects = [
    ...
    },
    {
      name: "Taskify",
      description:
        "Taskify is a easy to use task manager app with the capabilities of dragging and dropping tasks into different list to fit your schedule. Buildt with Nextjs",
