import {
  ...
  export const navLinks = [
    ...
    },
    {
      ...
      iconClassAlt: "text-primary",
      iconClassTitle: "text-primary",
      iconClassExternal: "text-primary",
      iconClassExternalAlt: "text-primary",
      iconClassExternalTitle: "text-primary",
