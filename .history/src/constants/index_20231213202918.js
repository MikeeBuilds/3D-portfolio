import {
  ...
  const projects = [
    ...
    },
    {
      name: "Taskify",
      description:
        "Taskify is a easy to use task manager for all of your tasks at hand. Complete with drag and drop capabilities. Allowing you to move around your tasks to different lists",
